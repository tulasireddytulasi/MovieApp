...
public class HindiMoviesDataModel {
    ...
    private List<ResultsBean2> results;
    ...
    public List<ResultsBean2> getResults() {
        return results;
    }

    public void setResults(List<ResultsBean2> results) {
        this.results = results;
    }

    public static class ResultsBean2 {
        /**
         * vote_count : 982
         * id : 429617
         * video : false
