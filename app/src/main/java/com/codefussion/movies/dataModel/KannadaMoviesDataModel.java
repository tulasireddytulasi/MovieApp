...
public class KannadaMoviesDataModel {
    ...
    private List<ResultsBean4> results;
    ...
    public List<ResultsBean4> getResults() {
        return results;
    }

    public void setResults(List<ResultsBean4> results) {
        this.results = results;
    }

    public static class ResultsBean4 {
